...
var trueFaveNum = faveNum == 29;// CODE HERE
...
var notHakeem = myName != "Hakeem Olajuwon";// CODE HERE
...
var responseCreator = function(param){
  if (param == "green") {
     colorResponse = "Green is okay";// CODE HERE
}else if (param == "red") {
